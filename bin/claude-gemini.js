...
async function main() {
  ...
  console.log("  ─────────────────────────────────────────────");
  console.log("    gemini@low     1K token thinking budget");
  console.log("    gemini@medium  8K token thinking budget");
  console.log("    gemini@high    32K token thinking budget  (default)");
  console.log("    gemini@xhigh   65K token thinking budget");
  console.log("");
